...
public struct HiggsGaugeInvariant: SystemCrystallizes {
    ...
    public typealias Cache       = Grew<Never, Never> // broken-symmetry history ACCUMULATES — irreversible (I3)
...
/// The Higgs vacuum under the FIELD-COMPONENT encoding: the vacuum manifold holds
...
public struct HiggsFieldComponents {
    public typealias SolutionSet = Cell<Three, Never> // |S| > 1: the Goldstone manifold
}
