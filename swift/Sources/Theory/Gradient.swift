// ═══════════════════════════════════════════════════════════════
// Distance Is Cost (Gradient) — paper 6.
//
...
/// a bijection), and the count is integer-valued (G2b). Not only on agents (DiD
/// S7 was a pseudometric). [DiC G2]
///
...
/// certifies at zero on the ``DistanceOnStructures`` metric (exact, permanent —
/// the system). Y-axis and Z-axis of one COMPARE. [DiC G13]
