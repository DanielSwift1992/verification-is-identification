// ═══════════════════════════════════════════════════════════════
// Law Is Target (Dynamics) — paper 9.
//
...
/// (pinned at ``HasLaw``) — so it carries a norm ‖f‖ and a distance W between
...
/// Traps are local minima — located and named, never promised absent.
/// [Law LT10-LT12]
///
...
/// re-enters with strictly more information. The loop is never silently wrong —
...
/// reports `|S|>1` persisting, never a confident wrong answer. [Law LT15]
