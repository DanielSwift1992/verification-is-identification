...
- term **Check it:** <doc:AtlasOrder> orders every claim after its premises. <doc:Atlas> counts each claim's dependents, <doc:AtlasAblation> records which premises the build needs (5 of 2396), <doc:AtlasRepeats> counts premises declared twice, and <doc:AtlasReview> lists the review's questions beside their answers.
