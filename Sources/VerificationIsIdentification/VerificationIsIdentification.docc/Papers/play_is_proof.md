...
5. Self-play makes coverage controllable: a directed poser saturates the closure with no external data and no critical slowing; a naive random poser only relocates the wall (PP5).
