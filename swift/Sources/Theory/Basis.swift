// ═══════════════════════════════════════════════════════════════
// Basis Is Residue (Basis) — paper B.
//
...
/// B1: certified rules denote functions and COMPOSE: R∘Q is itself a
...
/// B4–B8 (central): an atom is the FIXED POINT where the two norms COINCIDE,
...
/// B9–B10: atom-ness is a property of the sieve TRAJECTORY, not of a rule read
