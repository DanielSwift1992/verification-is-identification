...
The whole site is generated from this package. The 32 papers build the theory step by step. Two of them say where it ends: a system that only checks will eventually contain every answer and stop computing, and the distance between two such systems is measurable.
